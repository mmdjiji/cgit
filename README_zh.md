...
> 基于 [Alpine](https://alpinelinux.org/) 和 [Nginx](https://nginx.org/) 的超快 [Git](https://git-scm.com/) 仓库 Web 前端。

[CGit](https://git.zx2c4.com/cgit/about/) 是一个用 C 编写的 Git 仓库 Web 界面（[CGI](https://tools.ietf.org/html/rfc3875)）。
